...
import { Activity, BotAdapter, ResourceResponse, SkillConversationIdFactoryBase } from 'botbuilder-core';
...
export class CloudSkillHandler extends CloudChannelServiceHandler {
     ...
     */
    public readonly SkillConversationReferenceKey = Symbol('CloudSkillHandler.SkillConversationReference');
